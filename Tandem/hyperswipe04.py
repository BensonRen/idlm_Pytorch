...
if __name__ == '__main__':
    ...
    reg_scale_list = [5e-3]
    stop_thres_list = [0.1, 0.05, 0.01, 0.008, 0.005, 0.003, 0.001]
    ...
    #for linear_unit in linear_unit_list:
        ...
        for i in range(5, 8):
            ...
            for reg_scale in reg_scale_list:
                ...
                for j in range(2):
                        flags.model_name = flags.data_set + "stop_thres" + str(stop_thres) + "reg"+ str(flags.reg_scale) + "trail_"+str(j) + "_complexity_swipe_layer" + str(linear_unit) + "_num" + str(i)
