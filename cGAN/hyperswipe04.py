    ...
    #for linear_unit in linear_unit_list:
        ...
        #for i in range(4, 10):
            ...
            for reg_scale in reg_scale_list:
                ...
                for j in range(3):
                    flags.model_name = flags.data_set + "reg"+ str(flags.reg_scale) + "trail_"+str(j) + "_GAN_dim_spec_" + str(dim_spec) + "_dim_z_" + str(dim_z) + "swipe__num" + str(i)
