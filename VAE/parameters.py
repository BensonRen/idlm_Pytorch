...
DIM_Y = 2
DIM_SPEC = None
LINEAR_D = [DIM_Y + DIM_Z, 200, 200, 200, 200, 200, 200, 200,    DIM_X]           # Linear units for Decoder
LINEAR_E = [DIM_Y + DIM_X, 200, 200, 200, 200, 200, 200, 200,  2*DIM_Z]                   # Linear units for Encoder
